...
/// Function that shows an error and exits with failure
/// \param error
...
/// Class that use template functions to convert strings to other types  
/// \param val
/// \return 
class Convert
{
...
/// Class to read configuration files with structure:
/// name = value # comment
///
class ConfigFile
{
friend class SnimModel;
